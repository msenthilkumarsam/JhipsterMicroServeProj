...
public class JhipsterMicroServeProjApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterMicroServeProjApp.class);

    private final Environment env;

    public JhipsterMicroServeProjApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JhipsterMicroServeProj.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterMicroServeProjApp.class);
